...
* Windows: [SpecSync.AzureDevOps.Console.3.4.17.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.Console.3.4.17.zip)
* Linux: [SpecSync.AzureDevOps.3.4.17-linux-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.4.17-linux-x64.zip)
* OSX: [SpecSync.AzureDevOps.3.4.17-osx-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.4.17-osx-x64.zip)
* Any platform (.NET Core 3.1, .NET 6, 7 or .NET 8 SDK required): [SpecSync.AzureDevOps.3.4.17.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.4.17.zip)

## v3.3

* Windows: [SpecSync.AzureDevOps.Console.3.3.16.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.Console.3.3.16.zip)
* Linux: [SpecSync.AzureDevOps.3.3.16-linux-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.3.16-linux-x64.zip)
* OSX: [SpecSync.AzureDevOps.3.3.16-osx-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.3.16-osx-x64.zip)
* Any platform (.NET Core 3.1, .NET 5 or .NET 6 SDK required): [SpecSync.AzureDevOps.3.3.16.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.3.16.zip)
