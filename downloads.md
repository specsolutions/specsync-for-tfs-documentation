...
* Windows: [SpecSync.AzureDevOps.Console.3.4.5.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.Console.3.4.5.zip)
* Linux: [SpecSync.AzureDevOps.3.4.5-linux-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.4.5-linux-x64.zip)
* OSX: [SpecSync.AzureDevOps.3.4.5-osx-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.4.5-osx-x64.zip)
* Any platform (.NET Core 3.1, .NET 6 or .NET 7 SDK required): [SpecSync.AzureDevOps.3.4.5.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.4.5.zip)
