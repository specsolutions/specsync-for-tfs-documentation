...
* Windows: [SpecSync.AzureDevOps.Console.3.2.8.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.Console.3.2.8.zip)
* Linux: [SpecSync.AzureDevOps.3.2.8-linux-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.2.8-linux-x64.zip)
* OSX: [SpecSync.AzureDevOps.3.2.8-osx-x64.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.2.8-osx-x64.zip)
* Any platform (.NET Core 3.1, .NET 5 or .NET 6 SDK required): [SpecSync.AzureDevOps.3.2.8.zip](https://www.specsolutions.eu/media/specsync/SpecSync.AzureDevOps.3.2.8.zip)
