# Getting started with SpecSync using Cucumber or other Gherkin-based BDD tool
...
![Result of the first synchronization](img/getting-started-cucumber-first-sync.png)
