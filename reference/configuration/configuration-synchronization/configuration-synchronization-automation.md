...
```javascript
{
  ...
  "synchronization": {
    ...
    "automation": {
      ...
      "automatedTestStorage": "MyProject.dll"
    },
    ...
  },
  ...
...
| `automatedTestStorage` | Specifies the value to be used in the _Automated test storage_ field of the Test Case. | uses a strategy-dependent default value |
