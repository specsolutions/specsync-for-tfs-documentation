...
For details on how to include Test Cases to hierarchies, please check the [Synchronizing Test Case hierarchies using Test Suites](../common-synchronization-features/synchronizing-test-case-hierarchies.md) feature documentation.
