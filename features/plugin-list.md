...
| [SpecSync.Plugin.JestTestSource](https://github.com/specsolutions/specsync-plugins/tree/main/jest-test-source-plugin) | Allows synchronizing React/Jest tests from JavaScript, TypeScript, JSX & TSX files and publish results from Jest JSON result files. | Spec Solutions |
